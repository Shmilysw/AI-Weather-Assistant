...
//    String url1 = "https://apis.map.qq.com/ws/location/v1/ip?ip=&key=DZ5BZ-AL43T-RMIX6-LUPFG-7VUE3-GJBAO";
...
//        exchangeBg();
        ...
        System.out.println(provice_city+"11111111111111111111111111");
...
//                getImage(HAZE);
        ...
        View itemView = null;
        try {
            itemView = LayoutInflater.from(getActivity()).inflate(R.layout.item_main_center, null);
        } catch (Exception e) {
            return;
        }
