...
//            getWindow().addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_NAVIGATION);
    ...
    private void setRGListener() {
        ...
        exbgRg.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                else if (checkedId == R.id.more_rb_rain) {
                    if (bg == 3) {
                        Toast.makeText(MoreActivity.this,"您选择的为当前背景，无需改变！",Toast.LENGTH_SHORT).show();
                        return;
                    }
                ...
                else if (checkedId == R.id.more_rb_moren) {
                    if (bg == 4) {
                        Toast.makeText(MoreActivity.this,"您选择的为当前背景，无需改变！",Toast.LENGTH_SHORT).show();
                        return;
                    }
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.more_iv_back) {
            finish();
        }
        else if (v.getId() == R.id.more_tv_robot) {
...
//                startActivity(intent1);
        ...
        else if (v.getId() == R.id.more_tv_exchangebg) {
